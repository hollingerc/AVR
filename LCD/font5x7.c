 ...
 *
 * The data for this file came from several different source on the Internet.
 * My modifications were correcting some errors and modifying it so the 
 * compiler puts the data into FLASH memory instead of RAM.
 *
 ...
 */
#ifndef _FONT5X7_C_
#define _FONT5X7_C_ 1

#include <avr/pgmspace.h>

const char font5x7[][5] PROGMEM =
{
